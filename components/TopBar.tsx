      ...
      <div className="w-full px-2 sm:px-3 md:px-4 lg:px-6 max-w-7xl mx-auto">
        <div className="flex items-center justify-between py-2 sm:py-2.5 md:py-3 gap-2">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 lg:gap-4 flex-shrink-0">
            ...
            <a href="#" className="hover:underline whitespace-nowrap text-[11px] xs:text-xs sm:text-sm font-medium hidden sm:inline hover:opacity-90 transition-opacity">Sell with us</a>
            <a href="#" className="hover:underline whitespace-nowrap text-[11px] xs:text-xs sm:text-sm font-medium hidden md:inline hover:opacity-90 transition-opacity">Seller Login</a>
            <a href="#" className="hover:underline whitespace-nowrap text-[11px] xs:text-xs sm:text-sm font-medium hidden lg:inline hover:opacity-90 transition-opacity">Be a Partner</a>
            <a href="#" className="hover:underline whitespace-nowrap text-[11px] xs:text-xs sm:text-sm font-medium hidden xl:inline hover:opacity-90 transition-opacity">Ask Agro Experts</a>
            <a href="#" className="hover:underline whitespace-nowrap text-[11px] xs:text-xs sm:text-sm font-medium hidden xl:inline hover:opacity-90 transition-opacity">Track Order</a>
            <a href="#" className="hover:underline whitespace-nowrap text-[11px] xs:text-xs sm:text-sm font-medium hidden xl:inline hover:opacity-90 transition-opacity">Download APP</a>
          </div>
        </div>
      </div>
    </div>
